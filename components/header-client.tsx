...
function NavLink({
  ...
  return (
    <Link
      ...
      className={`inline-flex h-10 items-center border-b border-transparent px-1.5 text-sm font-medium transition-colors ${
        active
...
export function HeaderClient() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/90 backdrop-blur-xl">
      <div className="mx-auto grid h-[60px] w-full max-w-[980px] grid-cols-[1fr_auto_1fr] items-center gap-3 px-5 md:px-6">
        <div className="flex items-center">
          <Link
            href="/"
            className="inline-flex h-10 items-center gap-2 rounded-md text-base font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
          >
            Lee
